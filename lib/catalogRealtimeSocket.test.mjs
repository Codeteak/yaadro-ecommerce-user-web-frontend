...
test('shouldUseSameOriginCatalogRealtime does not force same-origin when REALTIME_URL is set', () => {
  ...
  try {
    // Explicit realtime host differs from shop host → cross-origin (CORS on API).
